...
- (id)init {
    self = [super init];
    if (self) {
        self.player1Color = [UIColor colorWithRed:0.44 green:0.76 blue:0.95 alpha:1.0];
        self.player1LightColor = [UIColor colorWithRed:0.76 green:0.86 blue:0.92 alpha:1.0];
        self.player2Color = [UIColor colorWithRed:0.4 green:0.82 blue:0.53 alpha:1.0];
        self.player2LightColor = [UIColor colorWithRed:0.73 green:0.92 blue:0.79 alpha:1.0];
